...
def show():
    """Display comprehensive soccer bankroll tracking"""
    
    st.markdown("""
    <div class="main-header">
        <h1>Soccer Bankroll Management</h1>
        <p>Track performance, manage risk, and analyze betting patterns</p>
    </div>
    """, unsafe_allow_html=True)
    
    db_manager = DatabaseManager()
    
    # Current bankroll metrics
    ...
    display_performance_charts('soccer', db_manager)
    
    st.markdown("---")
    
    # Betting history
    st.subheader("Recent Betting History")
    display_betting_history('soccer', db_manager)
    
    st.markdown("---")
    
    # Risk management metrics
    st.subheader("Risk Management Analysis")
    display_risk_metrics('soccer', db_manager)
...
# Copy this same structure for pages/tennis/bankroll_tracking.py (change sport='soccer' to sport='tennis')
# Copy this same structure for pages/cricket/bankroll_tracking.py (change sport='soccer' to sport='cricket') 
# Copy this same structure for pages/f1/bankroll_tracking.py (change sport='soccer' to sport='f1')

# pages/tennis/bankroll_tracking.py
def show():
    """Tennis bankroll tracking - same as soccer but with sport='tennis'"""
    import streamlit as st
    st.markdown("""
    <div class="main-header">
        <h1>Tennis Bankroll Management</h1>
        <p>Track tennis betting performance and manage risk</p>
    </div>
    """, unsafe_allow_html=True)
    
    # Use same functions as soccer but pass sport='tennis'
    display_bankroll_overview()
    ...
    st.subheader("Tennis Performance Analytics")
    display_performance_charts('tennis', db_manager)
    
    st.subheader("Tennis Betting History")
    display_betting_history('tennis', db_manager)
    
    st.subheader("Tennis Risk Analysis")
    display_risk_metrics('tennis', db_manager)
...
# pages/f1/bankroll_tracking.py
def show():
    """F1 bankroll tracking"""
    import streamlit as st
    st.markdown("""
    <div class="main-header">
        <h1>Formula 1 Bankroll Management</h1>
        <p>Track F1 betting performance and circuit-specific analysis</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    st.subheader("F1 Performance Analytics")
    display_performance_charts('f1', db_manager)
    
    st.subheader("F1 Betting History")
    display_betting_history('f1', db_manager)
    
    st.subheader("F1 Risk Analysis")
    display_risk_metrics('f1', db_manager)